            ...
            if (isMessageBanner) {
                ...
                if (side === 'left') {
                    ...
                    message = `
                        <div style="${style}">
                            <div>
                                <p style="margin-top: 0;">Cari affezionati giocatori, sto lavorando per aggiornare il codice di questi giochi.</p>
                                <p>Tra l'altro ho reintrodotto in Spider i suoni che non funzionavano più.</p>
                                <p>Se danno fastidio cliccate col tasto destro sul tab con il nome del programma e scegliete "disattiva l'audio del sito".</p>
                                <p>In caso di anomalie scrivetemi a <a href="mailto:postmaster@lucianomanenti.com" style="color: #ffd700;">postmaster@lucianomanenti.com</a></p>
                            </div>
                        </div>
                    `;
                    ...
                    message = `
                        <div style="${style}">
                            <div>
                                <p style="margin-top: 0;">Dear loyal players, I am working to update the code of these games.</p>
                                <p>Among other things, I have reintroduced sounds in Spider that were no longer working.</p>
                                <p>If they are annoying, right-click on the tab with the program name and choose "mute site audio".</p>
                                <p>In case of anomalies write to me at <a href="mailto:postmaster@lucianomanenti.com" style="color: #ffd700;">postmaster@lucianomanenti.com</a></p>
                            </div>
                        </div>
                    `;
                }
